...
public class Reporter extends TestEngine {
	 ...
	 * Developed By 		:- Pankaj Kumar (Cigniti Technologies)
	 * Date 				:- 15-May-2019
	...
	{
		if(Boolean.parseBoolean(objConfig.strPrintExceptionLog))
		{
			e.printStackTrace();
		}
	}
	...
	{
		try{
			if(Boolean.parseBoolean(objConfig.strScreenShot)==true)
			{
